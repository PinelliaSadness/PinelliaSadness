...
import com.summersadness.soa.cluster.engine.ClusterEngine;
...
public class RevokerProxyBeanFactory implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        //获取某个接口的服务提供者列表
        RegisterCenterForInvoker registerCenter4Consumer = RegisterCenter.singleton();
        List<ProviderService> providerServices = registerCenter4Consumer.getServiceProviderDataForInvoker().get(serviceKey);
        ...
        //设置本次调用的唯一标识
        request.setUuidKey(UUID.randomUUID().toString() + "-" + Thread.currentThread().getId());
        //设置本次调用的服务提供者信息
